...
public class BookFlight extends JFrame implements ActionListener{
    ...
    public BookFlight() {
        ...
        heading.setBounds(440, 15, 500, 35);
        ...
        Image i2 = i1.getImage().getScaledInstance(370, 270, Image.SCALE_DEFAULT);
        ImageIcon image = new ImageIcon(i2);
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(530, 80, 500, 410);
        add(lblimage);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==fetchButton){
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "Please enter correct aadhar/User not found");                
            }
